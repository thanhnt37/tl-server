    ...
    <div class="box-header with-border">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3 class="box-title">
                    <p class="text-right">
                        <a href="{!! action('Admin\BoxVersionController@create') !!}" class="btn btn-block btn-primary btn-sm" style="width: 125px;">@lang('admin.pages.common.buttons.create')</a>
                    </p>
                </h3>
                <br>
    ...
    <div class="box-body" style=" overflow-x: scroll; ">
        <table class="table table-bordered" id="box-version-index">
            ...
            @foreach( $boxVersions as $boxVersion )
                <tr>
                    <td>{{ $boxVersion->id }}</td>
                    <td>{{ $boxVersion->name }}</td>

                    <td>
                        <a href="{!! action('Admin\BoxVersionController@show', $boxVersion->id) !!}"
                        ...
                        <a href="#" class="btn btn-block btn-danger btn-xs delete-button"
                           data-delete-url="{!! action('Admin\BoxVersionController@destroy', $boxVersion->id) !!}">@lang('admin.pages.common.buttons.delete')</a>
                    </td>
                </tr>
            @endforeach
        </table>
