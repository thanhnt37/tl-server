    ...
    <div class="box-header with-border">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3 class="box-title">
                    <p class="text-right">
                        <a href="{!! action('Admin\GenreController@create') !!}" class="btn btn-block btn-primary btn-sm" style="width: 125px;">@lang('admin.pages.common.buttons.create')</a>
                    </p>
                </h3>
                <br>
    ...
    <div class="box-body" style=" overflow-x: scroll; ">
        <table class="table table-bordered">
            <tr>
                ...
                <th>{!! \PaginationHelper::sort('name', trans('admin.pages.genres.columns.name')) !!}</th>
            ...
            @foreach( $genres as $genre )
                <tr>
                    ...
                    <td>
                        <a href="{!! action('Admin\GenreController@show', $genre->id) !!}"
                        ...
                        <a href="#" class="btn btn-block btn-danger btn-xs delete-button"
                           data-delete-url="{!! action('Admin\GenreController@destroy', $genre->id) !!}">@lang('admin.pages.common.buttons.delete')</a>
                    </td>
                </tr>
            @endforeach
        </table>
